#testing another way with someone else's code 
#https://github.com/jschendel/Rosalind/blob/master/Textbook_01G.py
...
def main():
    ...
    # Read the input data.
    with open('testingFille.txt') as input_data:
    ...
    with open('frequent_ans.txt', 'w') as output_data:
